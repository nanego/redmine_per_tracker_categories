...
describe "FileChecksums" do
  ...
  it "should check core checksums" do
    ...
    # Redmine 5.1.2 is fine and previous ones too; 7.0.0 too (update action unchanged)
    assert_checksum %w"15dcb293c42721a34530d89570257106 bf3ee442a603c5f0759b3fc948a6ff95 27f849c985a952b4302ac4a5acd7c1ab b5d6e3adafc967c5fdf669e5cff0375f bfcd39e39a00f922f1633ad2061304c7 d7d6dda6fc37e6705174f25927b491c6", "app/controllers/issue_categories_controller.rb"
